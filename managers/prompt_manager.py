...
5. 對於[趨勢標題],參考代表事件，生成一個120字左右的趨勢洞察,提煉出該趨勢的核心特點和影響。趨勢洞察部份請精簡，長話短說，說重點即可，幫我控制在 150 字以內。
...
**請自行將小括號轉成 JSON 的大括號。**
        ...
        對每個趨勢各對應2-4個最具啟發性的[代表事件]，並簡要分析其意義，每則代表事件加分析至少要30字，不超過45字，在每則代表事件及分析後面幫我括號（代表事件從summary檔案來源的對應新聞）
        ...
        **請自行將小括號轉成 JSON 的大括號。**
        ...
        6. **請務必使用正確的 JSON 格式，使用大括號 {} 表示物件，方括號 [] 表示陣列。**
        '''
